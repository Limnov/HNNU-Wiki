...
> 可以忽略 font,music,pic 文件夹和 favicon.ico 文件。为了防止 API 调用过多这里就不给出具体代码了。

## 更更复杂一点的

一个更好炫酷的个人主页[Lumen - A stylish personal homepage made with vue.](https://github.com/Freakz3z/Lumen)